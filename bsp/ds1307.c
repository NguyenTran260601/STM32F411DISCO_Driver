...
uint8_t ds1307_init(void)
{
	...
	return ((clock_halt_state >> 7 ) & 0x1); //return 0: CH = 0; init success
}
...
void ds1307_set_current_time(RTC_time_t *rtc_time)
{
	...
	if(rtc_time->time_format == TIME_FORMAT_24_HRS){
		...
		hrs |= (1 << 6); //bit 6 set
		hrs = (rtc_time->time_format  == TIME_FORMAT_12_HRS_PM) ? hrs | ( 1 << 5) :  hrs & ~( 1 << 5) ; //PM -> bit 5 set
	}
...
static void ds1307_i2c_pin_config(void)
{
	...
	i2c_scl.GPIO_PinConfig.GPIO_PinPuPControl = DS1307_I2C_PUPD;
